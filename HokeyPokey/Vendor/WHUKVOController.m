 ...
 */
@interface _NEPKVOInfo : NSObject
@end

@implementation _NEPKVOInfo
{
@public
  __weak WHUKVOController *_controller;
  NSString *_keyPath;
...
- (instancetype)initWithController:(WHUKVOController *)controller keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options block:(FBKVONotificationBlock)block action:(SEL)action context:(void *)context
{
  self = [super init];
  if (nil != self) {
...
- (instancetype)initWithController:(WHUKVOController *)controller keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options block:(FBKVONotificationBlock)block
{
  return [self initWithController:controller keyPath:keyPath options:options block:block action:NULL context:NULL];
}

- (instancetype)initWithController:(WHUKVOController *)controller keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options action:(SEL)action
{
  return [self initWithController:controller keyPath:keyPath options:options block:NULL action:action context:NULL];
}

- (instancetype)initWithController:(WHUKVOController *)controller keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context
{
  return [self initWithController:controller keyPath:keyPath options:options block:NULL action:NULL context:context];
}

- (instancetype)initWithController:(WHUKVOController *)controller keyPath:(NSString *)keyPath
{
...
- (BOOL)isEqual:(id)object
{
  ...
  return [_keyPath isEqualToString:((_NEPKVOInfo *)object)->_keyPath];
}
 ...
 */
@interface _NEPKVOSharedController : NSObject

/** A shared instance that never deallocates. */
+ (instancetype)sharedController;

/** observe an object, info pair */
- (void)observe:(id)object info:(_NEPKVOInfo *)info;

/** unobserve an object, info pair */
- (void)unobserve:(id)object info:(_NEPKVOInfo *)info;
...
@implementation _NEPKVOSharedController
{
  NSHashTable *_infos;
  OSSpinLock _lock;
}
...
+ (instancetype)sharedController
{
  static _NEPKVOSharedController *_controller = nil;
  static dispatch_once_t onceToken;
  dispatch_once(&onceToken, ^{
    _controller = [[_NEPKVOSharedController alloc] init];
  });
  return _controller;
}
...
- (NSString *)debugDescription
{
  ...
  for (_NEPKVOInfo *info in _infos) {
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
  ...
  if (nil != info) {
    ...
    WHUKVOController *controller = info->_controller;
    if (nil != controller) {
...
@implementation WHUKVOController
{
...
- (NSString *)debugDescription
{
  ...
  for (id object in _objectInfosMap) {
    ...
    [infos enumerateObjectsUsingBlock:^(_NEPKVOInfo *info, BOOL *stop) {
      [infoDescriptions addObject:info.debugDescription];
    }];
...
- (void)_observe:(id)object info:(_NEPKVOInfo *)info
{
  // lock
  OSSpinLockLock(&_lock);
  ...
  _NEPKVOInfo *existingInfo = [infos member:info];
  if (nil != existingInfo) {
  ...
  [[_NEPKVOSharedController sharedController] observe:object info:info];
}

- (void)_unobserve:(id)object info:(_NEPKVOInfo *)info
{
  // lock
  OSSpinLockLock(&_lock);
  ...
  _NEPKVOInfo *registeredInfo = [infos member:info];
  ...
  // unobserve
  [[_NEPKVOSharedController sharedController] unobserve:object info:registeredInfo];
}
...
- (void)_unobserve:(id)object
{
  ...
  // unobserve
  [[_NEPKVOSharedController sharedController] unobserve:object infos:infos];
}
...
- (void)_unobserveAll
{
  ...
  _NEPKVOSharedController *shareController = [_NEPKVOSharedController sharedController];
...
- (void)observe:(id)object keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options block:(FBKVONotificationBlock)block
{
  ...
  // create info
  _NEPKVOInfo *info = [[_NEPKVOInfo alloc] initWithController:self keyPath:keyPath options:options block:block];
...
- (void)observe:(id)object keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options action:(SEL)action
{
  ...
  // create info
  _NEPKVOInfo *info = [[_NEPKVOInfo alloc] initWithController:self keyPath:keyPath options:options action:action];
...
- (void)observe:(id)object keyPath:(NSString *)keyPath options:(NSKeyValueObservingOptions)options context:(void *)context
{
  ...
  // create info
  _NEPKVOInfo *info = [[_NEPKVOInfo alloc] initWithController:self keyPath:keyPath options:options context:context];
...
- (void)unobserve:(id)object keyPath:(NSString *)keyPath
{
  ...
  _NEPKVOInfo *info = [[_NEPKVOInfo alloc] initWithController:self keyPath:keyPath];
